...
class CursesControl():
    ...
    def __init__(self, node_name, truck_topic_type, truck_topic_name,
        velocity_step = 50, angle_step = 50, truck_id = 2):
    ...
    def run(self):
        ...
        self.stdscr.addstr(0, 10,
            'Arrow keys or WASD to move truck. T to switch truck.')
...
def main(screen):
    ...
    curses_ctrl = CursesControl(node_name, truck_topic_type, truck_topic_name,
        velocity_step = velocity_step, angle_step = angle_step,
        truck_id = truck_id)
    curses_ctrl.run()
